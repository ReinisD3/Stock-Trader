    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <table class="table text-gray-400 border-separate space-y-6 text-sm">
                        ...
                        <tbody>
                            <tr class="bg-blue-100 lg:text-black">
                                ...
                                <td class="p-3 font-bold">{{$company->getPrice()}}</td>
                                ...
                                <td class="p-3 text-green-800 hover:text-green-400"><a href="{{$company->profile()->getWeburl()}}">Visit website</a></td>
                ...
                <form method="post" action="{{ route('stock.buy', $company->getSymbol() ) }}" class="content-center text-sm" >
                    @csrf

                    <input class="h-8" id="amount" name="amount" type="text" placeholder="Amount" >
                    <button type="submit" class="border-black border-2  bg-green-600 text-lg w-12">Buy</button><br>
